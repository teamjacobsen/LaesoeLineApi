...
{
    public class TimetableTests : IClassFixture<TestFixture>
    {
        private readonly TestFixture _fixture;

        public TimetableTests(TestFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        public async Task GetDepartures()
        {
            ...
            Assert.Contains(Vehicle.Car, departures[0].Availability.Keys);
        }
    }
}
