...
{
    public class CustumerBookingOneDayFoodTests : IClassFixture<TestFixture>
    {
        private readonly TestFixture _fixture;
        private readonly TestFixture.Credentials _credentials;

        public CustumerBookingOneDayFoodTests(TestFixture fixture)
        {
            _fixture = fixture;
            _credentials = fixture.GetCredentials("OneDayFood");
        }
        ...
        public async Task Book()
        {
            ...
            // When
            var booking = await _fixture.Api.CustomerBooking.BookOneDayFoodAsync(new CustomerBookingBookOneDay()
            {
